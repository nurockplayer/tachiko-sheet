...
export type ImportSelection = {
    column_types: ImportFieldType[][];
    extra_columns: Array<Array<{
        name: string;
        field_type: ImportFieldType;
    }>>;
};
export type InteropMetadata = {
    version: number;
    sheets: Array<{
        schema_id: string;
        name: string;
...
export type NativeTrackerExportPresentation = {
    version: number;
    rows: Array<{
        entity_id: string;
        styles: SourceStyle[];
...
export type CleanupPreview = {
    ...
    changes: Array<{
        target: FieldTarget;
        before: FieldProjection | null;
        after: StoredValueProjection | null;
    }>;
