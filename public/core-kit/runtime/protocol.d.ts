...
export type CanonicalProjectFile = {
    path: string;
    bytes: ArrayBuffer;
};
...
export type DesignerResponse = {
    ...
    payload: CleanupPreview;
} | {
    type: "import_preview";
    payload: SourceWorkbook;
} | {
    type: "imported";
    payload: ImportedProjection;
} | {
    type: "spreadsheet_exported";
    payload: {
        revision: string;
        byte_length: number;
    ...
    type: "bootstrap";
    payload: BootstrapProjection;
} | {
    type: "opened";
    payload: OpenedProjection;
} | {
    type: "table";
    payload: TableProjection;
} | {
    type: "fields";
    payload: FieldBatchProjection;
} | {
    type: "published";
    payload: PublicationProjection;
} | {
    type: "project_exported";
    payload: ProjectExportProjection;
} | {
    type: "canonical_tree_exported";
    payload: ProjectExportProjection;
} | {
    type: "portable_ro_exported";
    payload: ProjectExportProjection;
} | {
    type: "portable_ro_verified";
    payload: {
        accepted: boolean;
    };
} | {
...
export type WorkerReply = {
    ...
    id: number;
    status: "project_exported";
    export: ProjectExport;
} | {
    id: number;
    status: "canonical_tree_exported";
    export: CanonicalTreeExport;
} | {
    id: number;
    status: "portable_ro_exported";
    export: ProjectExport;
} | {
    id: number;
    status: "closed";
...
export declare const fieldTargetKey: (target: FieldTarget) => string;
