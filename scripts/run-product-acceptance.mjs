...
try {
  ...
  if (!serving.ready) {
    ...
    const localOk = j4 === 0 && j4Imported === 0 && j5 === 0 && interfaceProfile === 0 && appearanceSelector === 0 && primaryActions === 0 && normalUi === 0 && localM1 === 0 && localFocus === 0;
    ...
    exitCode = j4 === 0 && j4Imported === 0 && j5 === 0 && interfaceProfile === 0 && appearanceSelector === 0 && primaryActions === 0 && normalUi === 0 && browser === 0 && recovery === 0 && focus === 0 ? 0 : 1;
