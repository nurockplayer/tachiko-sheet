...
- 必須改 Sheet source、tests、dependency、host persistence、core pin或任何 acceptance oracle；建立另一個具體 child，重新檢查 Ready/owner/qualified Oracle consultation（`tachiko-conductor#79` contract）/independent adequacy。
