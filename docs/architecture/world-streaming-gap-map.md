...
- 必須改 Sheet source、tests、dependency、host persistence、core pin或任何 acceptance oracle；建立另一個具體 child，重新檢查 Ready/owner/independent adequacy，並依 DELIVERY 處理高風險 Sol consultation。
